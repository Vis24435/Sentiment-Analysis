...
if __name__ == '__main__':
    root=tk.Tk()   
    #img = ImageTk.PhotoImage(Image.open("brain.jpg"))
    heading = Label(root,text="Emojify",font=('arial',45,'bold'),bg='black')
    ...
    lmain3.pack()
    lmain3.place(x=760,y=150)
    lmain2.pack(side=RIGHT)
    lmain2.place(x=760,y=150)
    
    root.title("Emojify")            
    root.geometry("1400x900+100+10") 
    root['bg']='black'
    exitbutton = Button(root,pady=10, text='Quit',fg="red",command=root.destroy,font=('arial',20,'bold')).pack(side = BOTTOM)
    #exitbutton.place(x=60,y=180)
    show_vid()
    #print('passed')
    show_vid2()
    root.mainloop()